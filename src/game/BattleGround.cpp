...
void BattleGround::EndBattleGround(uint32 winner)
{
    ...
    for(BattleGroundPlayerMap::iterator itr = m_Players.begin(); itr != m_Players.end(); ++itr)
    {
        ...
        uint32 arena_gain_win = sWorld.getConfig(CONFIG_UINT32_BATTLEGROUND_WIN_ARENA_POINTS);
        uint32 arena_gain_lose = sWorld.getConfig(CONFIG_UINT32_BATTLEGROUND_LOSE_ARENA_POINTS);
        ...
        uint32 win_arena = plr->GetRandomWinner() ? arena_gain_lose : arena_gain_win;
