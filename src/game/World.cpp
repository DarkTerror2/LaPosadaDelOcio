...
void World::LoadConfigSettings(bool reload)
{
    ...
    setConfig(CONFIG_UINT32_BATTLEGROUND_WIN_ARENA_POINTS,             "Battleground.Win.Arena.Points", 0);
    setConfig(CONFIG_UINT32_BATTLEGROUND_LOSE_ARENA_POINTS,            "Battleground.Lose.Arena.Points", 0);
    ...
    setConfigMin(CONFIG_UINT32_TIME_FORCE_CLOSE_ARENA,                 "Arena.TimeForceClose", 2820000, 2820000);
